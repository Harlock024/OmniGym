...
class _AforoCard extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style:
                TextStyle(color: Theme.of(context).colorScheme.onSurfaceVariant, fontSize: 11),
          ),
          const SizedBox(height: 16),
          if (loading)
            const SizedBox(
          ...
          const SizedBox(height: 12),
          _Legend(
              color: Theme.of(context).colorScheme.primary, label: 'Entraron hoy', value: today),
          const SizedBox(height: 4),
          _Legend(
            color: Theme.of(context).dividerTheme.color ?? OmniGymColors.border,
  ...
  List<PieChartSectionData> _buildSections(BuildContext context, int today, int active) {
    if (active == 0) {
      return [
        PieChartSectionData(
            value: 1, color: Theme.of(context).dividerTheme.color ?? OmniGymColors.border, radius: 18, title: ''),
      ];
    }
