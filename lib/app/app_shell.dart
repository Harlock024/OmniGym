...
const _ownerItems = <_NavEntry>[
  ...
  _NavItem(icon: Icons.receipt_long_rounded, label: 'Facturación', route: '/facturacion'),
  ...
  _NavItem(icon: Icons.workspace_premium_rounded, label: 'Mi suscripción', route: '/subscription'),
